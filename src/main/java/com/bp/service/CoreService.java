...
public interface CoreService {
    ...
    List<Agency> queryAgencyByTime(Agency agency, String fromDate, String toDate, Integer page, Integer rows);

    List<OrderDetail> queryOrderDetailByTime(OrderDetail orderDetail, String fromDate, String toDate, Integer page, Integer rows);

    List<Order> queryOrderByTime(Order order, String fromDate, String toDate, Integer page, Integer rows);

    List<User> queryUserByTime(User user, String fromDate, String toDate, Integer page, Integer rows);
